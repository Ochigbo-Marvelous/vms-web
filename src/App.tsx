    ...
    <div className="hp-page">
      <header className={`hp-header${menuOpen ? " is-open" : ""}`}>
        ...
        <div className="hp-header-actions">
          <button className="hp-link" type="button">
            Sign in
          </button>
      ...
      <section className="hp-hero" id="top">
        ...
        <div className="hp-hero-actions">
          ...
          <button className="hp-btn hp-btn-ghost" type="button">
            Sign in
          </button>
          <button className="hp-btn hp-btn-text" type="button">
            Join →
          </button>
        </div>
      </section>
      ...
      <section className="hp-pricing" id="pricing">
        ...
        <div className="hp-price-well">
          <div className="hp-price-chip">
            <span className="hp-price-naira">₦60,000</span>
            <span className="hp-price-unit">per organization / year</span>
            <span className="hp-price-usd">$50 / year at checkout</span>
          </div>
